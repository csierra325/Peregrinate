...
export default class Example extends React.Component {
  ...
  render() {
    return (
     ...
     <FormGroup>
          <Label for="exampleSelectMulti" className = "PackingTitles">Essentials</Label>
          <Input type="select" className="packlistForm" id="essentialSelectMulti" multiple>
        ...
        <FormGroup>
          <Label for="exampleSelectMulti" className = "PackingTitles">Down To The Details</Label>
          <Input type="select" className="packlistForm" id="essentialSelectMulti" multiple>
            <option>Toothbrush, toothpaste, floss, mouthwash</option>
            <option>Hair brush or comb, hair ties, barrettes/bobby pins</option>
    ...
    <FormGroup>
          <Label for="exampleSelectMulti" className = "PackingTitles">Home Prep</Label>
          <Input type="select" className="packlistForm" id="essentialSelectMulti" multiple>
      ...
      <div className = "helpfulTitles">Packing Lists by Location: 
      <ul>
          <li><a href = "https://www.eaglecreek.com/blog/what-pack-uruguay-5-step-solution">What to Pack for Uruguay: The 5-Step Solution</a></li>
          <li><a href = "https://www.eaglecreek.com/blog/what-pack-greenland-five-step-solution">What To Pack For Greenland: The Five-Step Solution</a></li>     
          <li><a href ="Minimalist Travel: How to Pack Your Bag for Cuba ">Minimalist Travel: How to Pack Your Bag for Cuba </a></li>
          <li><a href = "https://www.eaglecreek.com/blog/what-pack-cambodia-5-step-solution">What to Pack for Cambodia: The 5 Step Solution</a></li>     
      </ul>
      </div>
      <div className = "helpfulTitles">Packing Lists by Activity: 
      <ul>
          <li><a href = "https://www.eaglecreek.com/blog/8-items-pack-super-active-summer-vacation">8 Items To Pack For a Super Active Summer Vacation</a></li>
          <li><a href = "https://www.eaglecreek.com/blog/what-pack-your-first-ragnar-relay-race">What to Pack for Your First Ragnar Relay Race</a></li>     
          <li><a href ="https://www.eaglecreek.com/blog/essential-packing-list-traveling-kitchen">The Essential Packing List for a Traveling Kitchen</a></li>
          <li><a href = "https://www.eaglecreek.com/blog/what-pack-weekend-sailing-trip">What to Pack for a Weekend Sailing Trip</a></li>     
        
      </ul>
      </div>

      <div className = "helpfulTitles">More Travel Checklists 
      <ul>
          <li><a href = "https://www.eaglecreek.com/blog/packing-light-cold-weather-getaway">Packing Light for a Cold Weather Getaway</a></li>
          <li><a href = "https://www.eaglecreek.com/blog/no-sweat-how-pack-ultimate-gym-bag">How To Pack the Ultimate Gym Bag</a></li>         
      </ul>
      </div>
